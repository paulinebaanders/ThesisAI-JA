#####################################################################
## parser.py is taken as is from JAGGPY package.
## sole modification: a negated nnf formula is again translated to nnf.
#####################################################################
...
class Parser:
    ...
    def to_cnf(self, sentence, variables):
        ...
        # Modified: prefix is changed, explicitly checked it is suitable.
        var_prefix = "_"
        ...
        # Modified: necessary when number of issues > 10
        my_string_preprocessed = my_string_preprocessed.replace(var_prefix+var_prefix, var_prefix)
    ...
    def translate_agenda(self, agenda):
        ...
        for label in agenda.keys():
            ...
            # Modified: in general negation of nnf formula is not nnf.
